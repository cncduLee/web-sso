...
public class Base64 {
    ...
    public static final char[] encodeToChar(byte[] data)
    {
        return encodeToChar(data, true);
    }
    ...
    public static final byte[] encodeToByte(byte[] data)
    {
        return encodeToByte(data, true);
    }
    ...
    {
        return new String(encodeToChar(data, true));
    }
